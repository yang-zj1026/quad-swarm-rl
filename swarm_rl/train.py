...
from swarm_rl.env_wrappers.quadrotor_params import add_quadrotors_env_args, quadrotors_override_defaults, add_adr_config
...
def parse_swarm_cfg(argv=None, evaluation=False):
    ...
    if final_cfg.use_adr:
        final_cfg = add_adr_config(final_cfg)
    return final_cfg
