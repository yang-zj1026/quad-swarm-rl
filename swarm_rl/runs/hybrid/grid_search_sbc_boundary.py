...
_params = ParamGrid(
    [
        ...
        ("quads_sbc_boundary", [0.05, 0.1, 0.2, 0.5])
    ]
)
...
OBSTACLE_MODEL_CLI = QUAD_BASELINE_CLI_8 + (
    ...
    '--with_wandb=True --wandb_project=Quad-Hybrid --wandb_user=multi-drones --wandb_group=grid_search_sbc_boundary'
)

_experiment = Experiment(
    "grid_search_sbc_boundary",
    OBSTACLE_MODEL_CLI,
