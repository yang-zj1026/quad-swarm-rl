...
--replay_buffer_sample_prob=0.75 --anneal_collision_steps=100000000 --anneal_collision_sim_steps=300000000 --save_milestones_sec=1800 \
...
--experiment=anneal_simulation_new
