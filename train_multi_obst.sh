...
--use_obstacles=True --quads_obstacle_size=0.6 --quads_obstacle_shape="cylinder" --quads_obstacle_density=0.2 \
--quads_obstacle_spawn_area 8 8 \
--quads_obst_collision_smooth_max_penalty=10.0 --quads_obst_collision_reward=5.0 \
--with_wandb=False --wandb_project=Quad-Swarm-RL --wandb_group=obstacles_test --wandb_user=multi-drones --use_curriculum_learning=True \
--experiment=obstacles_curriculum_test
