...
QUADS_MODE_LIST_OBSTACLES_TEST = ['o_random', 'o_static_same_goal', 'o_swap_goals', 'o_poly_spline', 'o_dynamic_same_goal']
...
QUADS_PARAMS_DICT = {
    ...
    'o_swap_goals': [QUADS_FORMATION_LIST_OBSTACLES, [18 * quad_arm_size, 18 * quad_arm_size]],
