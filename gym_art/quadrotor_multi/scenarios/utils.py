...
QUADS_MODE_LIST_OBSTACLES = ['o_random', 'o_dynamic_same_goal', 'o_dynamic_diff_goal']

QUADS_MODE_LIST_OBSTACLES_SINGLE = ['o_diagonal', 'o_dynamic_diff_goal', 'o_dynamic_same_goal']
